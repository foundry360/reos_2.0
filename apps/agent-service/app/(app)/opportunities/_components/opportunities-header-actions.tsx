...
import { OPPORTUNITY_VIEWS } from "@/lib/opportunities/opportunities-views";
import { DropdownOptionList } from "@/components/shell/dropdown-select";
import styles from "@/components/shell/shell.module.css";

interface OpportunitiesHeaderActionsProps {
...
export function OpportunitiesHeaderActions({ params }: OpportunitiesHeaderActionsProps) {
  ...
  const viewOptions = OPPORTUNITY_VIEWS.map((view) => ({
    value: view.id,
    label: view.label,
  }));
  ...
  const filterActive = params.view !== "all" || params.stage !== "all";
          ...
          <div className={styles.toolbarDropdown}>
            ...
            <div className={styles.dropdownBody}>
              ...
              <DropdownOptionList
                ...
                onChange={(view) =>
                  navigate({
                    view: view as OpportunityViewId,
                    stage: "all",
                    page: 1,
                  })
                }
